...
- Upload `/dist-extension/bottled-up-#.#.#-chrome.zip` to Chrome Web Store

## Building Tauri Application

Build portable app
- Run `npm run build-tauri`
- Open `.exe` in `/src-tauri/target/release/bottled-up.exe`
...
- Copy app files:
  - Copy `.exe` file: `D:\Development\bottled-up\src-tauri\target\release\`
  - Paste: `C:\steamworks\sdk\tools\ContentBuilder\content\bottled-up\windows`
